...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_complete_update(self):
        """Test complete update of a recipe."""
    ...
    def test_update_user_returns_error(self):
        """Test changing user results in an error."""
    ...
    def test_create_recipe_with_new_tags(self):
        """Test creating a recipe with new tag(s)."""

        payload = {
            'title': 'Chicken Biryani',
            'link': 'https://example.com/biryani.pdf',
            'description': 'Delicious chicken biryani',
            'time_minutes': 120,
            'price': Decimal('1000.00'),
            'tags': [{'name': 'Biryani'}, {'name': 'Lunch'}],
        }
    ...
    def test_create_recipe_with_existing_tags(self):
        """Test creating a recipe with existing tag(s)."""

        tag_Pakistani = Tag.objects.create(user = self.user, name = 'Pakistani')
        payload = {
            'title': 'Puri Channay',
            'link': 'https://example.com/puri-channay.pdf',
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user = self.user, title = 'Popcorn Chicken')
        r2 = create_recipe(user = self.user, title = 'Fried Chicken')
        tag1 = Tag.objects.create(user = self.user, name = 'Poultry')
        tag2 = Tag.objects.create(user = self.user, name = 'Bites')
        r1.tags.add(tag1)
        r2.tags.add(tag2)
        r3 = create_recipe(user = self.user, title = 'Crisp Burger')
    ...
    def test_filter_by_ingredients(self):
        ...
        r1 = create_recipe(user = self.user, title = 'Popcorn Chicken')
        r2 = create_recipe(user = self.user, title = 'Fried Chicken')
        ing1 = Ingredient.objects.create(user = self.user, name = 'Boneless Chicken')
        ing2 = Ingredient.objects.create(user = self.user, name = 'Drumsticks')
